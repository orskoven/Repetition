...
class SavedGame {
    ...
    public SavedGame(String saveWord, String wordToBeGuessed, int k, int i, int j) {
    ...
    public ArrayList<SavedGame> getSavedGames(){
        for (int i = 0; i < savedGames.size();i++){
            savedGames.add(new SavedGame(this.saveWord, this.wordToBeGuessed, this.k, this.i, this.j));
            i++;
        }
        return savedGames;
    }
